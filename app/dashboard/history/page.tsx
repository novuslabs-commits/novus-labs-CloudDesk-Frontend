  ...
  return (
    <div className="cd-page cd-cq">
      ...
      <div className="cd-head-gap">
        <h1 className="cd-title">History</h1>
        <p style={{ fontSize: "13px", color: "#6b7280", marginTop: "4px" }}>{total} tickets processed</p>
      </div>

      {/* Filter */}
      <div className="cd-wrap cd-segment" style={{ gap: "8px", marginBottom: "20px" }}>
        {[
          { key: "all", label: "All" },
          ...
          <button key={f.key} onClick={() => { setStatusFilter(f.key); setPage(1); }}
            className="cd-tap" aria-pressed={statusFilter === f.key}
            style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {tickets.map(ticket => {
            ...
            return (
              ...
              >
                <div className="cd-row" style={{ marginBottom: "10px" }}>
                ...
                <div className="cd-wrap" style={{ gap: "6px 16px", paddingTop: "10px", borderTop: "1px solid #1e1e2e" }}>
      ...
      {totalPages > 1 && (
        <div className="cd-pagination">
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            <button className="cd-tap" disabled={page === 1} onClick={() => setPage(p => p - 1)}
            ...
            <button className="cd-tap" disabled={page === totalPages} onClick={() => setPage(p => p + 1)}
